            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead className="text-xs flex w-full text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr className="flex w-full">
                        <th scope="col" class="p-4 w-1/4">Tháng</th>
                        <th scope="col" class="p-4 w-1/4 ">Tên khoản chi</th>
                        <th scope="col" class="p-4 w-1/4 ">Phân loại</th>
                        <th scope="col" class="p-4 w-1/4">Số tiền đã chi</th>
                    </tr>
                </thead>
